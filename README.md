# GAIDeT — Generative AI Declaration of Transparency
...
The package is designed to support emerging ethical, institutional, and publisher requirements concerning AI-assisted content creation. It implements the \emph{GAIDeT (Generative AI Delegation Taxonomy)}, as proposed in
...
Optional (integer) shrinking factor (useful in two-column layouts). Value 1 means slightly smaller.
...
Activated items are reflected automatically in the rendered declaration.  See the documentation for the full list of items.
