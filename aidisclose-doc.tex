...
\begin{itemize}
    \item \textbf{Checkmark Symbol:} \latexinline|\AIDsetCheckmarkSymbol{\texttimes}| (default is \latexinline|\checkmark|).
    \item \textbf{Font Size:} \latexinline|\AIDsetChecklistFontSize{\small}|
