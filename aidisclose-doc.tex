...
\begin{abstract}
    The \AIDpackageName\ package implements the \emph{GAIDeT (Generative AI Delegation Taxonomy)}~\cite{Suchikova:2025:GAIDeT} to automate Generative AI disclosure statements and checklists.
...
\AIDpreamble{<author> <AUTHOR_LIST>) <declares>/<acknowledges> the use of AI\ldots}
\end{ltx}
...
% \AIDrenderDeclaration[3]{Jane Doe}
